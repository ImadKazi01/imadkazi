...
const openApps = ref([
  {
    ...
    y: typeof window !== 'undefined' ? (window.innerWidth <= 768 ? 0 : Math.max(38, (window.innerHeight - 620) / 2)) : 38,
    width: typeof window !== 'undefined' ? (window.innerWidth <= 768 ? '95vw' : 1000) : 1000,
    height: typeof window !== 'undefined' ? (window.innerWidth <= 768 ? '85vh' : 620) : 620,
    visible: true,
